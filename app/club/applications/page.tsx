...
const MOCK_APPLICANTS: Applicant[] = [
  {
    id: '1', name: '刘雨欣', major: '英语专业', grade: '大一',
    contact: 'liuyuxin@edu.cn', mbti: 'ENFJ', zodiac: '白羊座',
    ...
    status: '待审核', appliedAt: '10分钟前', hasResume: true,
  },
  {
    id: '2', name: '陈思远', major: '戏剧影视学', grade: '大三',
    contact: '138-0013-8000', mbti: 'INFJ', zodiac: '双鱼座',
    ...
    status: '待审核', appliedAt: '1小时前', hasResume: true,
  },
  {
    id: '3', name: '林晓雨', major: '汉语言文学', grade: '大二',
    contact: 'linxiaoyu@edu.cn', mbti: 'ENFP', zodiac: '天蝎座',
    ...
    status: '待审核', appliedAt: '3小时前', hasResume: false,
  },
  {
    id: '4', name: '赵子轩', major: '心理学', grade: '大二',
    contact: 'zhaozixuan@edu.cn', mbti: 'INFJ', zodiac: '水瓶座',
    ...
    status: '已通过', appliedAt: '昨天 14:32', hasResume: true,
  },
  {
    id: '5', name: '李梦琪', major: '音乐表演', grade: '大二',
    contact: '139-5566-7788', mbti: 'INFP', zodiac: '巨蟹座',
    ...
    status: '待审核', appliedAt: '昨天 09:15', hasResume: false,
  },
  {
    id: '6', name: '张浩然', major: '计算机科学', grade: '大一',
    contact: 'zhanghaoran@edu.cn', mbti: 'INTJ', zodiac: '摩羯座',
    ...
    status: '已拒绝', appliedAt: '2天前', hasResume: true,
  },
  {
    id: '7', name: '王天明', major: '体育教育', grade: '大三',
    contact: '135-9900-1234', mbti: 'ESTP', zodiac: '狮子座',
    ...
    status: '待审核', appliedAt: '3天前', hasResume: false,
  },
];
...
// ─── Drawer (uses useLanguage internally) ────────────────────────────────────
      ...
      <div style={{ position: 'fixed', top: 0, right: 0, bottom: 0, width: '100%', maxWidth: 420, background: '#fff', zIndex: 50, overflowY: 'auto', boxShadow: '-4px 0 24px rgba(83,74,183,0.15)', animation: 'slideInRight 0.25s ease' }}>
        ...
        <div style={{ position: 'sticky', top: 0, zIndex: 1, background: '#fff', borderBottom: '1px solid #F0EEFF', padding: '16px 16px 12px', display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 12, color: '#9B8EC4', marginTop: 2 }}>{applicant.grade} · {applicant.major}</p>
          </div>
        </div>
        ...
        <div style={{ padding: '16px 16px 100px' }}>
          ...
          <Section title={t.basicInfo}>
            ...
            <InfoRow label={t.applyTime} value={applicant.appliedAt} />
...
export default function ApplicationsPage() {
  ...
  // Internal tab values stay Chinese to match applicant.status
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: 11, color: '#C4BAEC' }}>{t.appliedAt} {a.appliedAt}</span>
                    <button
